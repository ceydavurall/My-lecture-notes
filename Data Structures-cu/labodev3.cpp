...
int main() {
	...
	printf("Binary Search (array1)  --> index = %2d number = %d\n",pos,d1[pos]);
	...
	printf("Linear Search (array2) --> index = %d    number = %d\n", pos, d2[pos]);
	int result[size2];
	int num = sequentialSecondarySearchForIntArray(d2, size2, 5, result);
	printf("Linear Search (array2)  5 --> indexes = ");
	for (int i = 0; i < num; i++) {
		printf("%d ", result[i]);
	}
	printf("\n");
	...
	printf("Linear Search (array2)  48 --> indexes =  ");
	for (int i = 0; i < num; i++) {
		printf("%d ", result2[i]);
	}
	printf("\n");
	...
	int result21[10];
	char name[] = "MEHMET İPEK";
	pos = sequentialSecondarySearchForStudentName(students, name,result21);
	printf("linear-secondary-search-name:MEHMET İPEK\n");
	for (int i = 0; i < pos; i++) {
	...
	char name2[]="DENİZ UĞUR";
	pos = binaryPrimarySearchForStudentName(students, name2);
	printf("binary-primary-search-name:DENİZ UĞUR\n");
